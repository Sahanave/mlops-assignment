...
- Zero rows were returned but the question implies at least one row should exist
  (e.g. "which", "list", "how many ... that ...", "the most ..."). Exception:
  questions that explicitly ask about absence or non-existence ("students with
  no enrollment", "products never sold") may legitimately return zero rows.
